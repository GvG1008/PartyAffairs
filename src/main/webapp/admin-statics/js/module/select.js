...
$(document).ready(function() {
    ...
    var nations = ["蒙古族","回族","藏族","维吾尔族","苗族","彝族","壮族","布依族","朝鲜族","满族","侗族","瑶族","白族","土家族",
...
$(document).ready(function() {
    ...
    var units = ["研究生毕业年级学生"," 研究生一年级学生"," 研究生其他年级学生",
    ...
    for ( var i=0;i<units.length;i++) {
        var a=units[i];
        console.log(units[i]);
        unit.append("<option value='units[i]'>"+a+"</option>");
    }
