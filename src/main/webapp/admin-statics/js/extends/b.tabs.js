...
!function ($) {
	 ...
	 */
	var constants = {
		closeBtnTemplate : '<button type="button" class="navTabsCloseBtn" title="关闭" data-dismiss="alert" aria-label="Close"><span aria-hidden="true" id="close">×</span></button>',
		//设置该样式的tab不会被关闭
	...
	bTabs.prototype.addTab = function(id,title,url,loginCheck){
		...
		$('ul.nav-tabs',$tabs).append(
				'<li><a href="#'+tabId+'" data-toggle="tab" class="btab11" style="flex-shrink:1" title='+title+' >'+title+c.closeBtnTemplate+'</a></li>');
